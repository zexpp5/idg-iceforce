package com.chaoxiang.imrestful.request;
...
public class PutRequest extends OkHttpRequest
{
    ...
    public PutRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, List<FileInput> files)
    {
