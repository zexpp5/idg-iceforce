 ...
 */
public class DialogSuperUserFragment extends DialogFragment
{
    /**
     * @param title
     * @param message
     * @return
     */
    public static DialogSuperUserFragment newInstance(boolean isAdjust, String title, String message)
    {
        DialogSuperUserFragment instance = new DialogSuperUserFragment();
