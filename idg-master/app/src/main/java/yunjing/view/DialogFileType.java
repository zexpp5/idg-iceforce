 ...
 * 项目弹窗
 */
public class DialogFileType extends DialogFragment
{
    /**
     * @param title
     * @param message
     * @return
     */
    public static DialogFileType newInstance(boolean isShowCheck, boolean isAdjust, boolean isOnClickToReturn, String
            title, String message)
    {
        DialogFileType instance = new DialogFileType();
...
//        });
    ...
    private class Adapter extends BaseQuickAdapter<BeanIceProject, BaseViewHolder>
    {
        ...
        {
            super(R.layout.item_dialog_file_type, data);
        }
