...
/**
 */
public class DialogStringListFragment extends DialogFragment
{
     ...
     * @return
     */
    public static DialogStringListFragment newInstance(String message)
    {
        DialogStringListFragment instance = new DialogStringListFragment();
