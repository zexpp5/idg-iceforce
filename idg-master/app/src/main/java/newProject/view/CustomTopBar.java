...
public class CustomTopBar implements ITopBar
{
    ...
    public CustomTopBar(ViewGroup parent)
    {
        ...
        mBtnCancel = (ImageView) mTopBar.findViewById(R.id.btn_cancel);
        mBtnConfirm = (TextView) mTopBar.findViewById(R.id.btn_confirm);
        mTvTitle = (TextView) mTopBar.findViewById(R.id.tv_title);
    }
