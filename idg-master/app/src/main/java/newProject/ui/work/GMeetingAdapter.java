...
import com.cxgz.activity.cxim.ui.voice.list.VoiceListBean;
 ...
 */
public class GMeetingAdapter extends BaseQuickAdapter<GMeetingDataBean, BaseViewHolder>
{
    Context mContext;

    public GMeetingAdapter(Context context, @Nullable List<GMeetingDataBean> data)
    {
