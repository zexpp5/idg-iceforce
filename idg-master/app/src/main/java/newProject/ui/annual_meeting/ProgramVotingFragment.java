...
public class ProgramVotingFragment extends BaseFragment
{
    ...
    {
        return R.layout.activity_program_voting;
    }
    ...
    {
        ListHttpHelper.commitVotingList(getActivity(), meetId, itemIds, new SDRequestCallBack()
        {
            @Override
            public void onRequestFailure(HttpException error, String msg)
            {
    ...
    private class VotingAdapter extends BaseAdapter
    {
        ...
        public void setSelect(int position, ViewHolder finalHolder)
        {
            ...
            } else
            {
                ...
                {
                    MyToast.showToast(mContext, "最多选择三个节目");
