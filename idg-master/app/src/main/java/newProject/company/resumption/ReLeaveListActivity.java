 ...
 * 销假。
 */
public class ReLeaveListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //添加页卡视图
        mViewList.clear();
        mViewList.add(new LeaveStateOneFragment());
        mViewList.add(new LeaveStateTwoFragment());
        mViewList.add(new LeaveStateThreeFragment());
