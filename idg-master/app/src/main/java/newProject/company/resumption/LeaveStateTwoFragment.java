...
public class LeaveStateTwoFragment extends Fragment {
    ...
    private void getNetData() {
        ListHttpHelper.getResumptionList(getActivity(),signed, new SDRequestCallBack(ReleaveListBean.class) {
            @Override
    ...
    private class ApplyAdapter extends BaseQuickAdapter<ReleaveListBean.DataBean, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder holder, ReleaveListBean.DataBean item) {
            holder.setText(R.id.one_title, (null == item.getUserName() ? "" : DisplayUtil.getName(item.getUserName(),getActivity())) + "的销假")
