...
import newProject.company.vacation.VacationStateOneFragment;
import newProject.company.vacation.VacationStateThreeFragment;
import newProject.company.vacation.VacationStateTwoFragment;
import yunjing.view.CustomNavigatorBar;

/**
 * 我的出差
 */
public class BusinessTripListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //添加页卡视图
        mViewList.clear();
        mViewList.add(BusinessTripStateOneFragment.newInstance("1"));
        mViewList.add(BusinessTripStateOneFragment.newInstance("2"));
        mViewList.add(BusinessTripStateOneFragment.newInstance("3"));
