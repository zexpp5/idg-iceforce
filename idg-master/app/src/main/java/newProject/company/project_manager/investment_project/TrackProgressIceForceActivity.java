...
public class TrackProgressIceForceActivity extends BaseActivity {
    @Bind(R.id.title_bar)
    ...
    TrackProgressIceForceMultiAdapter adapter;
    ...
    protected void init() {
        ...
        mNavigatorBar.setRightImageOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TrackProgressIceForceActivity.this, TrackProgressAddActivity.class);
                intent.putExtra("flag","ADD");
                startActivity(intent);
            }
        });
        mNavigatorBar.setMidText("跟踪进展");

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new TrackProgressIceForceMultiAdapter(followProjectMultiBeen);
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (view.getId() == R.id.ll_voice){
                    ...
                    VoiceUtils.getInstance().getVoiceFromNet(TrackProgressIceForceActivity.this,followProjectMultiBeen.get(position).getData().getUrl(),ivVoice);*/
    ...
    private void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                if (DisplayUtil.hasNetwork(TrackProgressIceForceActivity.this))
                {
                    mPage = 0;
    ...
    public void getData(){
        ListHttpHelper.getFollowProjectList(this, SPUtils.get(this, USER_ACCOUNT, "").toString(),mPage+"", "10","","","","", new SDRequestCallBack(FollowProjectListBean.class) {
            @Override
    ...
    private void initVoiceListPopupWindow(View view,FollowProjectBaseBean bean){
        ...
        View contentView = LayoutInflater.from(TrackProgressIceForceActivity.this).inflate(R.layout.popupwindow_voice_list, null);
        RecyclerView voiceRecyclerView = (RecyclerView)contentView.findViewById(R.id.recycler_view);
        voiceRecyclerView.setLayoutManager(new LinearLayoutManager(TrackProgressIceForceActivity.this));
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    case R.id.iv_voice:
                        VoiceUtils.getInstance().getVoiceFromNet(TrackProgressIceForceActivity.this,((VoiceListBean)adapter.getData().get(position)).getUrl(),(ImageView) view);
                        break;
                }
            }
        });
