...
public class WorkCircleActivity extends BaseActivity {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (view.getId() == R.id.ll_voice){
                    ...
                    if ("POTENTIAL".equals(followProjectMultiBeen.get(position).getData().getProjType())){
                        intent.setClass(WorkCircleActivity.this, PotentialProjectsDetailActivity.class);
                    }else if ("INVESTED".equals(followProjectMultiBeen.get(position).getData().getProjType())){
                        intent.setClass(WorkCircleActivity.this, InvestedProjectsDetailActivity.class);
                    }else if("FOLLOW_ON".equals(followProjectMultiBeen.get(position).getData().getProjType())){
                        intent.setClass(WorkCircleActivity.this, FollowProjectDetailActivity.class);
                    }else {
    ...
    public void onItemClick(View view){
        switch (view.getId()){
            ...
            case R.id.iv_add:
                popuList.clear();
                String flag = (String) SPUtils.get(WorkCircleActivity.this, SPUtils.ROLE_FLAG, "0");
    ...
    private void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                if (DisplayUtil.hasNetwork(WorkCircleActivity.this))
                {
                    mPage = 1;
    ...
    public void getData(){
        ListHttpHelper.getFollowProjectList(WorkCircleActivity.this, SPUtils.get(WorkCircleActivity.this, USER_ACCOUNT, "").toString(),mPage+"", "10",state,comIndu,isMyFollow,dateRange, new SDRequestCallBack(FollowProjectListBean.class) {
            @Override
    ...
    private void getIndustryData() {
        ListHttpHelper.getIndustryListData(WorkCircleActivity.this, new SDRequestCallBack(PPIndustryListBean.class) {
            @Override
            public void onRequestFailure(HttpException error, String msg) {
    ...
    public void initTopPopupWindow(View view){
        View contentView = LayoutInflater.from(WorkCircleActivity.this).inflate(R.layout.popupwindow_work_circle_top, null);
        ...
        recyclerViewIndus.setLayoutManager(new GridLayoutManager(WorkCircleActivity.this,4));
        ...
        recyclerViewOther.setLayoutManager(new GridLayoutManager(WorkCircleActivity.this,4));
    ...
    public void initlistPopupWindow(View view,final String flag){
        ...
        final ListPopupWindow listPopupWindow = new ListPopupWindow(WorkCircleActivity.this);
        listPopupWindow.setWidth(340);
        listPopupWindow.setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
        listPopupWindow.setDropDownGravity(Gravity.RIGHT);
        final WorkCircleListPopupAdapter listPopupAdapter = new WorkCircleListPopupAdapter(popuList, WorkCircleActivity.this);
    ...
    private void initVoiceListPopupWindow(View view, FollowProjectBaseBean bean)
    {
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener()
        {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position)
            {
                ...
                {
                    case R.id.iv_voice:
                        VoiceUtils.getInstance().getVoiceFromNet(WorkCircleActivity.this, ((VoiceListBean) adapter.getData().get
    ...
    public void setBackgroundAlpha(float alpha){
        WindowManager.LayoutParams lp = WorkCircleActivity.this.getWindow().getAttributes();
        lp.alpha = alpha;
        WorkCircleActivity.this.getWindow().setAttributes(lp);
    }
