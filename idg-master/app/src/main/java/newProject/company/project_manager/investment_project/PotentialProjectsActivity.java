...
import newProject.company.project_manager.investment_project.fragment.PotentialProjectsGroupFragment;
import newProject.company.project_manager.investment_project.fragment.PotentialProjectsPersonalFragment;
...
public class PotentialProjectsActivity extends BaseActivity {
    @Bind(R.id.tabs)
    ...
    PotentialProjectsPersonalFragment pFragment;

    PotentialProjectsGroupFragment gFragment;
...
//        mNavigatorBar.setLeftTextOnClickListener(onClickListener);
        ...
        mNavigatorBar.setRightImageOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PotentialProjectsActivity.this,PotentialProjectsAddActivity.class);
        ...
        pFragment = new PotentialProjectsPersonalFragment();
        gFragment = new PotentialProjectsGroupFragment();
        mViewList.clear();
        mViewList.add(pFragment);
        mViewList.add(gFragment);
        PotentialProjectsActivity.MyPagerAdapter mAdapter = new PotentialProjectsActivity.MyPagerAdapter(getSupportFragmentManager(), mViewList, mTitleList);
            ...
            public void onClick(View view) {
                if (StringUtils.notEmpty(etKeyWord.getText())) {
                    if (mViewPager.getCurrentItem() == 0 ) {
                        pFragment.getSearchData(etKeyWord.getText().toString());
                    }else {
                        gFragment.getSearchData(etKeyWord.getText().toString());
                    }
                }
                popupWindow.dismiss();
            }
