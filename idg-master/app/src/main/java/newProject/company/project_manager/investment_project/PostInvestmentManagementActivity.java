...
public class PostInvestmentManagementActivity extends BaseActivity
{
    @Bind(R.id.title_bar)
    ...
    protected void init()
    {
        ...
        /*adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(PostInvestmentManagementActivity.this, PostInvestmentManagementDetailActivity.class);
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position)
            {
                switch (view.getId())
                {
                    case R.id.ll_item:                   //已投资详情
                        Intent intent = new Intent(PostInvestmentManagementActivity.this,
                        ...
                        break;
                    case R.id.ll_add:
                        Intent intent6 = new Intent(PostInvestmentManagementActivity.this, ActivityAddFollowUp.class);
    ...
    private void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                if (DisplayUtil.hasNetwork(PostInvestmentManagementActivity.this))
                {
                    mPage = 1;
    ...
    public void getData()
    {
        ListHttpHelper.getPostInvestmentManagementByManagerListData(this, SPUtils.get(this, USER_ACCOUNT, "").toString(), mPage
                + "", "10", key,new SDRequestCallBack(PostInvestmentListBean.class)
        {
            @Override
