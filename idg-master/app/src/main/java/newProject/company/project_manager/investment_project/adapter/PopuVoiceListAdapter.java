...
/**
 * Created by zsz on 2019/5/17.
 */

public class PopuVoiceListAdapter extends BaseQuickAdapter<VoiceListBean,BaseViewHolder>{
    public PopuVoiceListAdapter(@Nullable List<VoiceListBean> data) {
        super(R.layout.adapter_popu_voice_list, data);
    }
