...
public class PotentialProjectsDetailActivity extends BaseActivity
{
    @Bind(R.id.title_bar)
    ...
    {
        return R.layout.activity_potential_projects_detail;
    }
    ...
    @OnClick({R.id.btn_more, R.id.rl_score_record, R.id.btn_add, R.id.btn_upload,
            R.id.btn_change, R.id.ll_star,R.id.rl_meeting,R.id.rl_files,R.id.btn_prof})
    public void onItemClick(View view)
    {
        ...
        {
            case R.id.btn_more:
                intent = new Intent(PotentialProjectsDetailActivity.this, TrackProgressActivity2.class);
            ...
            case R.id.rl_meeting:
                //跳会议讨论界面
                Intent meeting = new Intent(PotentialProjectsDetailActivity.this, ActivityInvestmentMeeting.class);
                Bundle b = new Bundle();
            ...
            case R.id.rl_files:
                //跳项目文档界面
                Intent intent2 = new Intent(PotentialProjectsDetailActivity.this, ActivityInvestmentFile.class);
            ...
            case R.id.rl_score_record:
                intent = new Intent(PotentialProjectsDetailActivity.this, ScoreRecordActivity.class);
                intent.putExtra("projId", getIntent().getStringExtra("projId"));
                startActivity(intent);
                break;
            case R.id.btn_add:
                intent = new Intent(PotentialProjectsDetailActivity.this, TrackProgressAddActivity.class);
    ...
    private void initPopupWindow(View view, final int flag)
    {
        ...
        ListPopupAdapter listPopupAdapter = new ListPopupAdapter(popuList, PotentialProjectsDetailActivity.this);
        ...
        listPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
            {
                if (flag == 1)
                {
                    updateProjectState(dataBean.getProjId(), datas.get(i).getCodeKey(), i,flag);
                } else if (flag == 2)
                {
                    int type;
                    ...
                    updateProjectState(dataBean.getProjId(), followStates.get(i).getStatusCode(), i,flag);
                }
                ...
                .getStringExtra("projId"), new SDRequestCallBack(PotentialProjectsDetailBean.class)
        {
            ...
            public void onRequestSuccess(SDResponseInfo responseInfo)
            {
                ...
                if (dataBean != null)
                {
                    ...
                    if (StringUtils.notEmpty(dataBean.getIndusGroupStr()) && dataBean.getIndusGroupStr().equals("PE")){
                                ...
                                llVoiceOne.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    public void onClick(View view)
                                    {
                                        ...
                                        } else
                                        {
                                            ...
                                            VoiceUtils.getInstance().getVoiceFromNet(PotentialProjectsDetailActivity.this,
                                                    pathOne, ivFpOne);
                                        }
    ...
    private void updateProjectState(String pid, String sid, final int i,final int flag)
    {
    ...
    {
        ListHttpHelper.updateFollowStateData(this, SPUtils.get(this, USER_ACCOUNT, "").toString(), dataBean.getProjId(), new
                SDRequestCallBack()
                {
                    @Override
                    public void onRequestFailure(HttpException error, String msg)
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
            {
                if (i == 0)
                {
                    if (permission == 1)
                    {
                        ...
                        {
                            Intent intent = new Intent(PotentialProjectsDetailActivity.this, ActivityQxbSearch.class);
                            intent.putExtra("companyName", projName);
                            startActivity(intent);
                        }
                    } else
                    {
                        Intent intent = new Intent(PotentialProjectsDetailActivity.this, AtActivity.class);
                        intent.putExtra("projName", projName);
                        intent.putExtra("projId", getIntent().getStringExtra("projId"));
                        startActivity(intent);
                    }
                ...
                {
                    Intent intent = new Intent(PotentialProjectsDetailActivity.this, PotentialProjectsEditActivity.class);
    ...
    public void initPopupWindowForPrivacy(View view)
    {
        ...
        btnAgree.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                ListHttpHelper.updateProjectPrivacy(PotentialProjectsDetailActivity.this, SPUtils.get
                        (PotentialProjectsDetailActivity.this, USER_ACCOUNT, "").toString(), dataBean.getProjId(), privacy, new
    ...
    private void initVoiceListPopupWindow(View view, String paths, String audioTimes)
    {
        ...
        View contentView = LayoutInflater.from(PotentialProjectsDetailActivity.this).inflate(R.layout.popupwindow_voice_list,
                null);
        RecyclerView voiceRecyclerView = (RecyclerView) contentView.findViewById(R.id.recycler_view);
        voiceRecyclerView.setLayoutManager(new LinearLayoutManager(PotentialProjectsDetailActivity.this));
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener()
        {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position)
            {
                ...
                {
                    case R.id.iv_voice:
                        VoiceUtils.getInstance().getVoiceFromNet(PotentialProjectsDetailActivity.this, ((VoiceListBean) adapter
