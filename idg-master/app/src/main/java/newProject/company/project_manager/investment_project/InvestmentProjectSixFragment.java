 ...
 * 会议信息
 */
public class InvestmentProjectSixFragment extends Fragment
{
    ...
    public static Fragment newInstance(int id, String company)
    {
        Bundle args = new Bundle();
        args.putInt("EID", id);
        args.putString("title", company);
        InvestmentProjectSixFragment fragment = new InvestmentProjectSixFragment();
    ...
    {
        ListHttpHelper.getMettingList(getActivity(), mEid, new SDRequestCallBack(MeetingListBean.class)
        {
            @Override
    ...
    private String mMeettingUrl = "/project/opinion/detail/h.htm?opinionId=";

    private void initAdapter()
    {
        mAdapter = new InverstmentProjectSixAdapter(R.layout.item_investment_project_six_layout, mDataLists);
    ...
    {
        ListHttpHelper.approvalMeet(getActivity(), eid, new SDRequestCallBack()
        {
            @Override
            public void onRequestFailure(HttpException error, String msg)
            {
