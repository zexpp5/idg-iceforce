...
public class FollowProjectGroupFragment extends Fragment {
    ...
    public void getData(){
        ListHttpHelper.getPotentialGroupList(getActivity(), SPUtils.get(getActivity(), USER_ACCOUNT, "").toString(), "FOLLOW_ON", mPage+"", "10", key, "", "", comIndu, "",stsId,new SDRequestCallBack(PotentialProjectsPersonalBean.class) {
            @Override
