...
import newProject.company.project_manager.investment_project.adapter.ResearchReportAdapter;
...
public class ResearchReportActivity extends BaseActivity {
    ...
    String groupId = "";
    ResearchReportAdapter adapter;
    List<ResearchReportItemListBean.DataBeanX.DataBean> datas = new ArrayList<>();
    ...
    protected void init() {
        ...
        adapter = new ResearchReportAdapter(datas);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Intent intent = new Intent(ResearchReportActivity.this, WebVacationActivity.class);
    ...
    private void initRefresh() {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                if (DisplayUtil.hasNetwork(ResearchReportActivity.this)) {
                    mPage = 1;
                    keyword = "";
    ...
    public void getTabsData() {
        ListHttpHelper.getResearchTabsData(this, new SDRequestCallBack(ReSearchReportTabsBean.class) {
            @Override
    ...
    public void getGroupData() {
        ListHttpHelper.getResearchGroupListData(this, SPUtils.get(this, USER_ACCOUNT, "").toString(), groupId, mPage + "", "10", new SDRequestCallBack(ResearchReportItemListBean.class) {
            @Override
            public void onRequestFailure(HttpException error, String msg) {
                SDToast.showShort(msg);
            }
            ...
            @Override
            public void onRequestSuccess(SDResponseInfo responseInfo) {
                ResearchReportItemListBean bean = (ResearchReportItemListBean) responseInfo.getResult();
    ...
    public void getGroupDataByKeyword() {
        ListHttpHelper.getResearchGroupListDataByKeyword(this, SPUtils.get(this, USER_ACCOUNT, "").toString(), keyword, mPage + "", "10", tabs.get(tabIndex).getIndusGroup(),new SDRequestCallBack(ResearchReportItemListBean.class) {
            @Override
            public void onRequestFailure(HttpException error, String msg) {
                SDToast.showShort(msg);
            }
    ...
    public String getURL(String eid) {
        String url = Constants.getIp() + "/iceforce/preview/file/readFile/holder.htm?fileId=" + eid + "&username=" + SPUtils.get(this, USER_ACCOUNT, "").toString();// + "&token="+SPUtils.get(this, SPUtils.ACCESS_TOKEN, "").toString();
        return url;
    }
