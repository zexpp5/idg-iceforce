...
public class FollowProjectListActivity extends BaseActivity {
    @Bind(R.id.tabs)
    ...
    FollowProjectPersonalFragment personalFragment;
    FollowProjectGroupFragment groupFragment;
...
//        mNavigatorBar.setLeftTextOnClickListener(onClickListener);
        ...
        mViewList.clear();
        personalFragment = new FollowProjectPersonalFragment();
        mViewList.add(personalFragment);
        groupFragment = new FollowProjectGroupFragment();
