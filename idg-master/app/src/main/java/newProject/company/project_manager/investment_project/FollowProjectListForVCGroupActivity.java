...
import newProject.company.project_manager.investment_project.adapter.FollowProjectListForVCGroupAdapter;
...
public class FollowProjectListForVCGroupActivity extends BaseActivity {
    @Bind(R.id.title_bar)
    ...
    FollowProjectListForVCGroupAdapter adapter;
...
//        mNavigatorBar.setLeftTextOnClickListener(onClickListener);
    ...
    private void initViews() {
        recyclerView.setLayoutManager(new LinearLayoutManager(FollowProjectListForVCGroupActivity.this));
        adapter = new FollowProjectListForVCGroupAdapter(datas);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.ll_item:
                        Intent intent = new Intent(FollowProjectListForVCGroupActivity.this, FollowProjectDetailForVCGroupActivity.class);
                    ...
                    case R.id.tv_state2:
                        ...
                        break;
                    case R.id.iv_star:
                        if (SPUtils.get(FollowProjectListForVCGroupActivity.this, SPUtils.IS_MANAGER_MY, "0").equals("1")) {
    ...
    private void initRefresh() {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                if (DisplayUtil.hasNetwork(FollowProjectListForVCGroupActivity.this)) {
                    mPage = 1;
    ...
    public void getData() {
            ...
            ListHttpHelper.getPotentialPersonalListForVCGroup(this, SPUtils.get(this, USER_ACCOUNT, "").toString(), mPage + "", "10",  key, "", "", stsId,comIndu,"1", "",new SDRequestCallBack(PotentialProjectsPersonalBean.class) {
                @Override
    ...
    public void initPopupWindow(View view, String flag, final String projId, final int pos) {
        ...
        View contentView = LayoutInflater.from(FollowProjectListForVCGroupActivity.this).inflate(R.layout.popupwindow_star, null);
    ...
    public void updateFollowUpStatus(String projId, final String follUpStatus, final int pos) {
        ListHttpHelper.updateFollowUpStatus(FollowProjectListForVCGroupActivity.this, SPUtils.get(FollowProjectListForVCGroupActivity.this, USER_ACCOUNT, "").toString(), projId, follUpStatus, new SDRequestCallBack(IDGBaseBean.class) {
            @Override
            public void onRequestFailure(HttpException error, String msg) {
