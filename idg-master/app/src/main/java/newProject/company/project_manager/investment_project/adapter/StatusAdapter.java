...
public class StatusAdapter extends BaseQuickAdapter<IDGTpyeBaseBean.DataBeanX.DataBean,BaseViewHolder> {
    public StatusAdapter(@Nullable List<IDGTpyeBaseBean.DataBeanX.DataBean> data) {
    ...
    protected void convert(BaseViewHolder helper, IDGTpyeBaseBean.DataBeanX.DataBean item) {
        ...
        if (item.isFlag()){
            ...
            textView.setBackground(mContext.getResources().getDrawable(R.drawable.tv_bg_gray));
