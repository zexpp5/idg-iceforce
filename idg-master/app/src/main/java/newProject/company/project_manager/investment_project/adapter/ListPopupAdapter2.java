...
public class ListPopupAdapter2 extends BaseAdapter {

    private List<String> mArrayList;
    private Context mContext;

    public ListPopupAdapter2(List<String> list, Context context) {
        super();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.popupwindow_list_2, null, false);
