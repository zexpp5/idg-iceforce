...
public class PotentialProjectsList2Activity extends BaseActivity {
    @Bind(R.id.title_bar)
    ...
    PotentialProjectsPersonalAdapter adapter;
...
//        mNavigatorBar.setLeftTextOnClickListener(onClickListener);
        ...
        mNavigatorBar.setMidText("潜在项目");
        mNavigatorBar.setRightImageOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PotentialProjectsList2Activity.this,PotentialProjectsAddActivity.class);
    ...
    private void initViews(){
        recyclerView.setLayoutManager(new LinearLayoutManager(PotentialProjectsList2Activity.this));
        adapter = new PotentialProjectsPersonalAdapter(datas);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    case R.id.ll_item:
                        Intent intent = new Intent(PotentialProjectsList2Activity.this, PotentialProjectsDetailActivity.class);
                    ...
                    case R.id.tv_state:
                        ...
                        break;
                    case R.id.iv_star:
                        if (SPUtils.get(PotentialProjectsList2Activity.this,SPUtils.IS_MANAGER_MY,"0").equals("1")) {
    ...
    private void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                if (DisplayUtil.hasNetwork(PotentialProjectsList2Activity.this))
                {
                    mPage = 1;
                    stsId = null;
                    key = null;
    ...
    public void getData(){
        ...
        if (SPUtils.get(PotentialProjectsList2Activity.this,SPUtils.IS_MANAGER_MY,"0").equals("1")) {
            //个人
            ListHttpHelper.getPotentialPersonalList(PotentialProjectsList2Activity.this, SPUtils.get(PotentialProjectsList2Activity.this, USER_ACCOUNT, "").toString(), "POTENTIAL", mPage + "", "10", key, "", "", "", "", stsId, new SDRequestCallBack(PotentialProjectsPersonalBean.class) {
                @Override
            ...
            ListHttpHelper.getPotentialGroupList(PotentialProjectsList2Activity.this, SPUtils.get(PotentialProjectsList2Activity.this, USER_ACCOUNT, "").toString(), "POTENTIAL", mPage+"", "10", key, "", "", "", "",stsId,new SDRequestCallBack(PotentialProjectsPersonalBean.class) {
                @Override
                public void onRequestFailure(HttpException error, String msg) {
                    mTips.showAccessFail();
                }
    ...
    public void initPopupWindow(View view,String flag,final String projId, final int pos){
        ...
        View contentView = LayoutInflater.from(PotentialProjectsList2Activity.this).inflate(R.layout.popupwindow_star, null);
    ...
    public void updateFollowUpStatus(String projId,final String follUpStatus,final int pos){
        ListHttpHelper.updateFollowUpStatus(PotentialProjectsList2Activity.this, SPUtils.get(PotentialProjectsList2Activity.this, USER_ACCOUNT, "").toString(), projId, follUpStatus, new SDRequestCallBack(IDGBaseBean.class) {
            @Override
            public void onRequestFailure(HttpException error, String msg) {
