package newProject.company.project_manager.estate_project;
...
//房地产项目
public class ProjectEstateListActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener
{
    ...
    private void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                if (DisplayUtil.hasNetwork(ProjectEstateListActivity.this))
                {
                    /*s_projName="";
                    s_induIds="";
                    s_stageIds ="";*/
