...
public class ProjectEstateAdapter extends BaseQuickAdapter<EstateList.DataBean, BaseViewHolder> {
    public ProjectEstateAdapter(@Nullable List<EstateList.DataBean> data) {
