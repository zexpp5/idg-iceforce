...
public class InvestedProjectGroupFragment extends Fragment {
    ...
    public void getData(){
        ListHttpHelper.getPotentialGroupList(getActivity(), SPUtils.get(getActivity(), USER_ACCOUNT, "").toString(), "INVESTED", mPage+"", "10", key, "", "", comIndu, projInvestedStatus,"",new SDRequestCallBack(PotentialProjectsPersonalBean.class) {
            @Override
