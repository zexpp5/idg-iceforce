...
public class ProjectLibAdapter extends BaseQuickAdapter<EstateList.DataBean, BaseViewHolder> {
    public ProjectLibAdapter(@Nullable List<EstateList.DataBean> data) {
