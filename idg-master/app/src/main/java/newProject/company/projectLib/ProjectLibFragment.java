package newProject.company.projectLib;
...
//项目库
public class ProjectLibFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener
{
    ...
    ProjectLibAdapter projectLibAdapter;

    @Override
    protected int getContentLayout()
    {
        return R.layout.fragment_project_lib_main;
    }
...
//        mNavigatorBar.setLeftTextOnClickListener(onClickListener);
        ...
        mNavigatorBar.setMidText(getActivity().getString(R.string.super_tab_02));
        recycler_view.setLayoutManager(new LinearLayoutManager(getActivity()));

        projectLibAdapter = new ProjectLibAdapter(new ArrayList<EstateList.DataBean>());
        recycler_view.setAdapter(projectLibAdapter);
        initRefresh();
        ...
        getData();
        projectLibAdapter.setOnItemClickListener(this);
    }
    ...
    {
        mPage = 1;
        projectLibAdapter.getData().clear();
        getData();
    }
    ...
    public void getData()
    {
        ListHttpHelper.getProjectEstateList(getActivity(), mPage + "", new SDRequestCallBack(EstateList.class)
        {
            ...
            public void onRequestSuccess(SDResponseInfo responseInfo)
            {
                ...
                projectLibAdapter.getData().addAll(data);
                projectLibAdapter.notifyDataSetChanged();
            }
        });
    }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position)
    {
        ...
        int projId = projectLibAdapter.getData().get(position).getProjId();
