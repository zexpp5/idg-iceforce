...
public class DocumentLibAdapter extends BaseQuickAdapter<EstateList.DataBean, BaseViewHolder> {
    public DocumentLibAdapter(@Nullable List<EstateList.DataBean> data) {
