...
import newProject.company.hr.LeaveApplyActivity;
...
public class VacationListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mTitleBar.setRightImageOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(VacationListActivity.this, LeaveApplyActivity.class));
            }
        });
        ...
        //添加页卡视图
        mViewList.clear();
        mViewList.add(new VacationStateOneFragment());
        mViewList.add(new VacationStateTwoFragment());
        mViewList.add(new VacationStateThreeFragment());
