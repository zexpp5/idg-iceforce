...
public class VacationStateOneFragment extends Fragment
{
    ...
    private class ApplyAdapter extends BaseQuickAdapter<NewLeaveListBean.NewLeaveDataBean, BaseViewHolder>
    {
        ...
        protected void convert(BaseViewHolder holder, NewLeaveListBean.NewLeaveDataBean item)
        {
            ...
            holder.setText(R.id.two_content, null == item.getLeaveType() ? "" : item.getLeaveType());
            holder.setText(R.id.three_content, null == item.getLeaveStart() ? "" : item.getLeaveStart());
            holder.setText(R.id.four_content, null == item.getLeaveEnd() ? "" : item.getLeaveEnd());
