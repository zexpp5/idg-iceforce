 ...
 * 风险信息
 */
public class ActivityQxbRiskInfo extends BaseActivity
{
    ...
    private List<BeanQxbHazardInfo.DataBeanX.DataBean> mDataLists = new ArrayList<>();
    ...
    public void initRefresh()
    {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener()
        {
            ...
            {
                pageNo = 1;
                if (DisplayUtil.hasNetwork(ActivityQxbRiskInfo.this))
                {
                    getNetData();
...
//                    }
    ...
    {
        ListHttpHelper.gethazardInfo(ActivityQxbRiskInfo.this, companyName, pageNo, pageSize,
                new SDRequestCallBack(BeanQxbHazardInfo.class)
                {
                    @Override
                    ...
                    {
                        BeanQxbHazardInfo listBean = (BeanQxbHazardInfo) responseInfo.getResult();
                        if (pageNo == 1)
                        {
    ...
    private void initAdapter()
    {
        ...
        DividerItemDecoration2 dividerItemDecoration2 = new DividerItemDecoration2(ActivityQxbRiskInfo.this,
                DividerItemDecoration2.VERTICAL_LIST, R.drawable.recyclerview_divider, ScreenUtils.dp2px
                (ActivityQxbRiskInfo.this, 0));
        mRecyclerview.addItemDecoration(dividerItemDecoration2);
        mRecyclerview.setLayoutManager(new LinearLayoutManager(ActivityQxbRiskInfo.this));
        mRecyclerview.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener()
        {
            public void onItemClick(BaseQuickAdapter adapter, View view, int position)
            {
                BeanQxbHazardInfo.DataBeanX.DataBean dataBean = mDataLists.get(position);
...
//                }
    ...
    private class InverstmentProjectFileAdapter extends BaseQuickAdapter<BeanQxbHazardInfo.DataBeanX.DataBean,
            BaseViewHolder>
    {
        public InverstmentProjectFileAdapter(@LayoutRes int layoutResId, @Nullable List<BeanQxbHazardInfo.DataBeanX
                .DataBean> data)
        {
        ...
        @Override
        protected void convert(BaseViewHolder holder, BeanQxbHazardInfo.DataBeanX.DataBean item)
        {
