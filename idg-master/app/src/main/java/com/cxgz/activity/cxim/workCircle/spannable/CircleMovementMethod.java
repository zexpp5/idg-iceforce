...
public class CircleMovementMethod extends BaseMovementMethod
{
    ...
    private final static int DEFAULT_COLOR_ID = R.color.transparency;
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.transparency;
    /**
     * 整个textView的背景色
     */
    ...
    {
        this.textViewBgColor = BaseApplication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = BaseApplication.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
                                ...
                                MotionEvent event)
    {
        ...
        } else if (action == MotionEvent.ACTION_UP)
        {
            ...
            widget.setBackgroundResource(R.color.transparency);
