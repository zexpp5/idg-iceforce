...
import com.cxgz.activity.cxim.workCircle.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout
{
    ...
    {
        return onItemNameClickListener;
    }
    ...
    protected void initAttrs(AttributeSet attrs)
    {
        ...
        try
        {
            ...
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.white));
    ...
    public void notifyDataSetChanged()
    {
        ...
        for (int i = 0; i < mDatas.size(); i++)
        {
            ...
            if (view == null)
            {
                throw new NullPointerException("listview item layout_city is null, please check getView()...");
            }
    ...
    private View getView(final int position)
    {
        ...
        View convertView = layoutInflater.inflate(R.layout.work_circle_item_comment, null, false);
        ...
        builder.append(setClickableSpan(name, bean.getUser().getId(), position));

        if (!TextUtils.isEmpty(toReplyName))
        {
            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, bean.getToReplyUser().getId(), position));
        }
        builder.append(": ");
        //转换表情字符
    ...
    @NonNull
    private SpannableString setClickableSpan(final String textStr, final String id, final int position)
    {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor)
                                {
                                    ...
                                    {
                                        onItemNameClickListener.onNameClick(position, id);
    ...
    public static interface OnItemNameClickListener
    {
