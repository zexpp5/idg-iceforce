 ...
 * FIXME 业绩提交
 */
public class BusinessAchievementSubmitFragment extends ERPSumbitBaseFragment
{
    ...
    {
        BusinessAchievementSubmitFragment fragment = new BusinessAchievementSubmitFragment();
        return fragment;
    }
    ...
    {
        return R.layout.erp_im_fragment_achievement_submit_main;
    }
    ...
    {
        setTitle(this.getResources().getString(R.string.im_business_achievement_submit));
        ...
        addRightBtn(this.getResources().getString(R.string.button_send), new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                if (TextUtils.isEmpty(imBusinessMoneySubmitEdt.getText().toString().trim()))
                {
                    MyToast.showToast(getActivity(), getString(R.string.im_business_submit_achievement_money_empty));
                    return;
                }
                if (!StringUtils.checkDecimalString92(imBusinessMoneySubmitEdt.getText().toString().trim()))
                {
                    MyToast.showToast(getActivity(), getString(R.string.im_business_submit_achievement_money_error));
                    return;
                }
    ...
    private void getData(String yourBossId, String annex)
    {
        ...
        String money = imBusinessMoneySubmitEdt.getText().toString().trim();

        String receiveId = yourBossId;

        showProgress();
        BasicDataHttpHelper.findAchievementSubmit2(getActivity(), name, remark,
                receiveId, money, annex, new SDRequestCallBack()
                {
                    @Override
...
//
//        showProgress();
//        BasicDataHttpHelper.findAchievementSubmit(getActivity().getApplication(), name, remark, receiveId, money, false, files, imgPaths, voice, new FileUpload.UploadListener()
//        {
//            @Override
//            public void onSuccess(SDResponseInfo responseInfo, HashMap<String, Object> result)
//            {
