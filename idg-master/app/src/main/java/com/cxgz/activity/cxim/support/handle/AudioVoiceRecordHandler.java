 ...
 * 用于录音的帮助类
 */
public class AudioVoiceRecordHandler implements Runnable {
    ...
    public AudioVoiceRecordHandler(String fileName) {
        super();
    ...
    private void setMaxVolume(short[] buffer, int readLen) {
        try {
            ...
            Msg.obj = max;
            VoiceVideoActivity.getUiHandler().sendMessage(Msg);
        } catch (Exception e) {
            SDLogUtil.debug(e.getMessage());
        }
    }
