...
public class BusinessBorrowMoneySubmitFragment extends ERPSumbitBaseFragment
{
    ...
    {
        BusinessBorrowMoneySubmitFragment fragment = new BusinessBorrowMoneySubmitFragment();
        return fragment;
    }
    ...
    {
        setTitle(this.getResources().getString(R.string.im_business_borrow_money_submit));
        ...
        addRightBtn(this.getResources().getString(R.string.button_send), new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                startActivityForResult(intent, REQUEST_CODE_FOR_BORROW_MONEY);
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        switch (requestCode)
        {
            case REQUEST_CODE_FOR_BORROW_MONEY:
...
//                        MyToast.showToast(getActivity(), R.string.request_fail);
    ...
    private void postFile()
    {
        ImHttpHelper.submitFileApi(getActivity().getApplication(), "", false, files, imgPaths, voice, new FileUpload.UploadListener()
        {
            ...
            {
                FileSubmitBean callBean = new SDGson().fromJson(responseInfo.getResult().toString(),
                        new TypeToken<FileSubmitBean>()
                {
                }.getType());
    ...
    private void getData(String yourBossId, String annex)
    {
        ...
        showProgress();
        BasicDataHttpHelper.findBorrowMoneySubmit2(getActivity(), name, remark, receiveId, money, annex, new SDRequestCallBack()
        {
            @Override
...
//
//        showProgress();
//        BasicDataHttpHelper.findBorrowMoneySubmit(getActivity().getApplication(), name, remark, receiveId, money, false, files, imgPaths, voice, new FileUpload.UploadListener()
//        {
//            @Override
//            public void onSuccess(SDResponseInfo responseInfo, HashMap<String, Object> result)
//            {
...
//                MyToast.showToast(getActivity(), getActivity().getResources().getString(R.string.request_succeed));
//                getActivity().finish();
////                ((BusinessActivity) getActivity()).replaceFragment(new BusinessBorrowMoneySubmitFragment());
//            }
//
//            @Override
//            public void onProgress(int byteCount, int totalSize)
