 ...
 */
public class MyPadingTextView extends TextView
{
    ...
    public MyPadingTextView(Context context)
    {
        super(context);
        init();
    }

    public MyPadingTextView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public MyPadingTextView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public void init()
    {
        ...
        //字间距
        xPadding = dip2px(this.getContext(), 2.25f);
        //行间距
        yPadding = dip2px(this.getContext(), 4f);
        //比较小的字间距（字母和数字应紧凑）
