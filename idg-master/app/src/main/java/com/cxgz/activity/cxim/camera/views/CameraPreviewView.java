package com.cxgz.activity.cxim.camera.views;
...
public class CameraPreviewView extends FrameLayout
{
    ...
    public CameraPreviewView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        {
            mIndicatorView.setImageResource(R.mipmap.ms_smallvideo_icon);
        } else
        {
    ...
    private void initTextView(Context context)
    {
        ...
        //设置为半透明
        rl.setBackgroundColor(getResources().getColor(R.color.all_transparent));
        ...
        RelativeLayout.LayoutParams relLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 10);
        ...
        textViewPrompt.setTextSize(12);
        textViewPrompt.setBackgroundColor(Color.TRANSPARENT);
        textViewPrompt.setTextColor(Color.BLUE);
        textViewPrompt.setText(R.string.text_view_prompt);
       /* textViewPrompt.setGravity(Gravity.CENTER_HORIZONTAL);*/
        ...
        relLayoutParams2.bottomMargin = 40;
      /*  relLayoutParams2.leftMargin=200;*/
        rl.addView(textViewPrompt, relLayoutParams2);

        addView(rl, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.BOTTOM+Gravity.CENTER_HORIZONTAL));
