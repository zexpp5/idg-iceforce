...
//         }
    ...
    {
        String user = "512160530@qq.com";// 邮箱的用户名
        String password = "zictdbbqmjcibjch"; // 邮箱的密码
...
//        Session session = Session.getInstance(prop, new GMailAuthenticator(user, password));
        int total = 0;
        IMAPStore store;
        try
        {
