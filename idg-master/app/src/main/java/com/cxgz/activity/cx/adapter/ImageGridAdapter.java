...
public class ImageGridAdapter extends BaseAdapter
{
    ...
    private List<Image> mnewmSelectedImages = new ArrayList<>();
    ...
    public void setData(List<Image> images)
    {
       ...
       /* }*/
        if (mnewmSelectedImages != null && mnewmSelectedImages.size() > 0)
        {
            mSelectedImages = mnewmSelectedImages;
        }
    ...
    public List<Image> getMnewmSelectedImages()
    {
        return mnewmSelectedImages;
    }

    public void setMnewmSelectedImages(List<Image> mnewmSelectedImages)
    {
        this.mnewmSelectedImages = mnewmSelectedImages;
    }
}
