...
public class EmptyLayoutForList {
    ...
    private String mErrorMessage = "网络不稳定，请重新加载";
    private String mEmptyMessage = "暂无相关数据";
    ...
    /**
     * Gets the loading layout_city
     *
     * @return the loading layout_city
     */
    public ViewGroup getLoadingView() {
        return mLoadingView;
    }

    public void setOnErrorOnClickListener(OnClickListener clickListener) {
        mErrorView.setOnClickListener(clickListener);
    }

    public void setOnEmptyOnClickListener(OnClickListener onClickListener) {
        mEmptyView.setOnClickListener(onClickListener);
    }

    /**
     * Sets loading layout_city
     * @param loadingView the layout_city to be shown when the list is loading
     */
    ...
    /**
     * Sets loading layout_city resource
     *
     * @param res the resource of the layout_city to be shown when the list is loading
     */
    ...
    /**
     * Gets the empty layout_city
     *
     * @return the empty layout_city
     */
    ...
    /**
     * Sets empty layout_city
     *
     * @param emptyView the layout_city to be shown when no items are available to load in the list
     */
    ...
    /**
     * Sets empty layout_city resource
     *
     * @param res the resource of the layout_city to be shown when no items are available to load in the list
     */
    ...
    /**
     * Gets the error layout_city
     *
     * @return the error layout_city
     */
    ...
    /**
     * Sets error layout_city
     *
     * @param errorView the layout_city to be shown when list could not be loaded due to some error
     */
    ...
    /**
     * Sets error layout_city resource
     *
     * @param res the resource of the layout_city to be shown when list could not be loaded due to some error
     */
     ...
     * @param messageViewId the id of the text view within the error layout_city whose text will be changed into this message
     */
     ...
     * @param messageViewId    the id of the text view within the empty layout_city whose text will be changed into this message
     */
     ...
     * @param messageViewId  the id of the text view within the loading layout_city whose text will be changed into this message
     */
    ...
    /**
     * Gets the view in the loading layout_city which will be animated when the list is being loaded
     *
     * @return the view in the loading layout_city which will be animated when the list is being loaded
     */
    ...
    /**
     * Sets the view in the loading layout_city which will be animated when the list is being loaded
     *
...
//			mListView.setEmptyView(rl);
     ...
     */
    public EmptyLayoutForList(Context context) {
        mContext = context;
     ...
     */
    public EmptyLayoutForList(Context context, ListView listView) {
        mContext = context;
        mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mListView = listView;
    }
    ...
    /**
     * Shows the empty layout_city if the list is empty
     */
    ...
    /**
     * Shows loading layout_city if the list is empty
     */
    ...
    /**
     * Shows error layout_city if the list is empty
     */
