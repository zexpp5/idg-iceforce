...
public class SlideDateTimePicker
{
     ...
     * format is used.</p>
     *
     * <p>This also affects the time displayed in the mTabs.</p>
     *
    ...
    /**
     * Sets the color of the underline for the currently selected mTabs.
     *
     * @param indicatorColor  the color of the selected mTabs's underline
     */
