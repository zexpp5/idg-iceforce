...
/**
 * Created by selson on 2019/5/11.
...
public class AutoEditTextView extends AppCompatEditText
{
    ...
    private void initData(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        leftText = typeArray.getString(R.styleable.AutoEditTextView_leftTextEd);
        leftTextColor = typeArray.getColor(R.styleable.AutoEditTextView_leftTextColorEd, getColor(R.color.text_black_xxxl));
        leftTextSize = typeArray.getFloat(R.styleable.AutoEditTextView_leftTextSizeEd, sp2px(16f));
        ...
        leftTextPadding = typeArray.getInt(R.styleable.AutoEditTextView_leftTextPaddingEd, dip2px(8));
        downLineDefaultColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineDefaultColor, getColor(R.color
                .transparency));
        downLineFocusColor = typeArray.getColor(R.styleable.AutoEditTextView_downLineFocusColor, getColor(R.color.transparency));
        typeArray.recycle();
        setBackground(null);
        initPaint();
    }
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (!TextUtils.isEmpty(leftText))
        {
            canvas.drawText(leftText, getScrollX(), (getMeasuredHeight() - mTextPaint.getTextSize()) / 2 + mTextPaint
                            .getTextSize(),
                    mTextPaint);
        }
        //绘制底部的线
        if (isShowDownLine)
        {
            canvas.drawLine(getScrollX(), this.getHeight() - dip2px(1), getScrollX() + this.getWidth(), this.getHeight() -
                            dip2px(1),
                    mLinePaint);
        }
    }
    ...
    private void dealRightButtonClickType()
    {
        ...
        {//隐藏和显示密码
            ...
            setTransformationMethod(isShowPass ? HideReturnsTransformationMethod.getInstance() : PasswordTransformationMethod
                    .getInstance());
            setCompoundDrawables(getCompoundDrawables()[0], getCompoundDrawables()[1],
                    isShowPass ? getDrawable(R.mipmap.close_icon) : getDrawable(R.mipmap.open_icon),
