...
public class WheelRecycle {
	...
	/**
	 * Recycles items from specified layout_city.
	 * There are saved only items not included to specified range.
	 * All the cached items are removed from original layout_city.
	 * 
	 * @param layout the layout_city containing items to be cached
	 * @param firstItem the number of first item in layout_city
