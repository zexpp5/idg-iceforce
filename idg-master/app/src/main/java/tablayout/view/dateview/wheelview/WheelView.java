...
package tablayout.view.dateview.wheelview;
...
import tablayout.view.dateview.wheelview.adapter.WheelViewAdapter;
...
//			0xFFFFFFFF, 0xFFFFFFFF };
	...
	// The number of first item in layout_city
	 ...
	 * Actual amount of visible items depends on wheel layout_city parameters.
	...
	/**
	 * Calculates desired height for layout_city
	 * 
	 * @param layout
	 *            the source layout_city
	 * @return the desired layout_city height
	 */
	 ...
	 * @param widthSize the input layout_city width
	 * @param mode the layout_city mode
	 ...
	 * @param width the layout_city width
	 * @param height the layout_city height
	 */
	...
	/**
	 * Adds view for item to items layout_city
	 * @param index the item index
