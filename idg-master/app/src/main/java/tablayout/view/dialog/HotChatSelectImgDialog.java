 ...
 */
public class HotChatSelectImgDialog extends SDStyleDialog implements SDStyleDialog.OnStyle1DialogListener {

    public HotChatSelectImgDialog(Context context, String[] strings) {
    ...
    public void itemClickListener(View parent, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                onSelectImgListener.onClickVideo(v);
                break;
//            case 1:
