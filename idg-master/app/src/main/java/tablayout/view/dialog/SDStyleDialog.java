...
public class SDStyleDialog extends SDNoTileDialog implements OnClickListener
{
    ...
    public SDStyleDialog(Context context, String[] strings, String titleString, int dialogType)
    {
        super(context);
        this.context = context;
        this.strings = strings;
    ...
    public SDStyleDialog(Context context, String[] strings, int[] unreads, int dialogType, OnStyle1DialogListener
            onStyle1DialogListener)
    {
        super(context);
        this.context = context;
        this.strings = strings;
