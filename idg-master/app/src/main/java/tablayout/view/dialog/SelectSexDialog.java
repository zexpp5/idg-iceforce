 ...
 */
public class SelectSexDialog extends SDStyleDialog implements SDStyleDialog.OnStyle1DialogListener {

	public SelectSexDialog(Context context, String[] strings) {
