 ...
 */
@SuppressLint("NewApi")
public class MBCustomSpinner extends LinearLayout implements OnClickListener{
	...
	public MBCustomSpinner(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init(context, attrs, 0);
	}

	public MBCustomSpinner(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context, AttributeSet attrs, int defStyle){
		...
		btnTextColor = a.getColor(R.styleable.CustomSpinnerAttr_buttonTextColor, getResources().getColor(R.color.black));
		itemTextColor = a.getColor(R.styleable.CustomSpinnerAttr_itemTextColor_me, getResources().getColor(R.color.black));
