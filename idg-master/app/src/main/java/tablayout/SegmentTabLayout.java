...
import tablayout.utils.FragmentChangeManager;
import tablayout.utils.UnreadMsgUtils;
import tablayout.widget.MsgView;
...
//    private int selected_tab_bg;//被选中背景色
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_color, Color.parseColor("#004e26"));//未选中时字体颜色
//        selected_tab_bg = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_selected_tab_bg, Color.parseColor("#ffffff"));
        ...
        mTextSelectColor = ta.getColor(R.styleable.SegmentTabLayout_tl_textSelectColor, Color.parseColor("#004e26"));//选中字体颜色
        mTextUnselectColor = ta.getColor(R.styleable.SegmentTabLayout_tl_textUnselectColor, mIndicatorColor);//未选中时字体颜色
...
//        mIndicatorDrawable.setColor(selected_tab_bg);// 选中当前tab背景色
        mIndicatorDrawable.setColor(getResources().getColor(R.color.white));
        mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
                (int) mIndicatorMarginTop, (int) (paddingLeft + mIndicatorRect.right - mIndicatorMarginRight),
                (int) (mIndicatorMarginTop + mIndicatorHeight));
//        mIndicatorDrawable.setCornerRadii(mRadiusArr);// 选中的时候 背景图四个圆角半径
